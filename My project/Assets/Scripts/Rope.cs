...
public class Rope : MonoBehaviour
{
    ...
    [SerializeField] Transform rodPos;
    ...
    void Start()
    {
        ...
        Vector3 ropeStartPoint = rodPos.position + new Vector3(0.4f, 0.4f, 0);
    ...
    private void ApplyConstrains()
    {
        ...
        firstSegment.posNow = rodPos.position + new Vector3(0.4f, 0.4f, 0);
